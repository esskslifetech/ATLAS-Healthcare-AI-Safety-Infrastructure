...
export interface PatientProxyConfig {
  ...
  // New: integration with care coordinator
  careCoordinator?: {
    emitEvents: boolean;
    eventTopic?: string;
  };
...
class ContentTemplater {
  ...
  personalize(template: ContentTemplate, patientName: string, symptoms: string[], additional?: Record<string, string>): string {
...
class EducationalContentService {
  ...
  suggest(symptoms: string[]): string | null {
    // Find best match
...
export function createPatientProxyAgent(config?: PatientProxyConfig): PatientProxyAgent {
