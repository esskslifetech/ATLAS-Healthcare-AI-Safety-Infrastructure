...
class ContentTemplater {
    ...
    personalize(template, patientName, symptoms) {
...
class PatientProxyAgent {
    ...
    async processMessage(message) {
        ...
        try {
            ...
            const session = await this.sessionManager.withSession(validatedMessage.session_id, async (s) => {
    ...
    updateSessionContext(session, message, analysis) {
        if (!session.context)
            session.context = { escalation_triggered: false, vital_signs_collected: false, triage_performed: false, consent_obtained: false, provider_notified: false };
...
//# sourceMappingURL=patient-proxy.js.map