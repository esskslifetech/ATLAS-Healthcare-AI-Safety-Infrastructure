...
exports.PatientResource = exports.PatientResourceError = exports.PatientSchema = exports.PatientContactSchema = exports.PatientIdentifierSchema = void 0;
exports.setTracer = setTracer;
exports.createPatientResource = createPatientResource;
...
exports.PatientContactSchema = zod_1.z.object({
    relationship: zod_1.z.array(zod_1.z.object({
        coding: zod_1.z.array(zod_1.z.object({
            system: zod_1.z.string(),
            code: zod_1.z.string(),
            display: zod_1.z.string().optional(),
    ...
    name: zod_1.z.object({
        use: zod_1.z.enum(['usual', 'official', 'temp', 'nickname', 'anonymous', 'old']).optional(),
    ...
    telecom: zod_1.z.array(zod_1.z.object({
        system: zod_1.z.enum(['phone', 'fax', 'email', 'pager', 'url', 'sms', 'other']),
        value: zod_1.z.string(),
...
exports.PatientSchema = zod_1.z.object({
    ...
    identifier: zod_1.z.array(exports.PatientIdentifierSchema).optional(),
    ...
    deceasedBoolean: zod_1.z.boolean().optional(),
    deceasedDateTime: zod_1.z.string().optional(),
    ...
    multipleBirthBoolean: zod_1.z.boolean().optional(),
    multipleBirthInteger: zod_1.z.number().optional(),
    contact: zod_1.z.array(exports.PatientContactSchema).optional(),
    communication: zod_1.z.array(zod_1.z.object({
    ...
    generalPractitioner: zod_1.z.array(zod_1.z.object({
        reference: zod_1.z.string(),
        display: zod_1.z.string().optional(),
    })).optional(),
    managingOrganization: zod_1.z.object({
        reference: zod_1.z.string(),
        display: zod_1.z.string().optional(),
    }).optional(),
    link: zod_1.z.array(zod_1.z.object({
...
// ==================== Custom Error ====================
class PatientResourceError extends Error {
...
exports.PatientResourceError = PatientResourceError;
...
class PatientResource {
    ...
    async create(patient) {
        ...
        try {
            const validated = exports.PatientSchema.parse(patient);
    ...
    // ==================== Convenience Methods ====================
    async findByMrn(mrn, system) {
        const params = { identifier: mrn };
        if (system) {
...
// ==================== Convenience Factory ====================
function createPatientResource(client, config) {
