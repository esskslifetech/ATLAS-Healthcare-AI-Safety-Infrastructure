...
const defaultConfig: ObservationResourceConfig = {
...
// ==================== Custom Error ====================
export class ObservationResourceError extends Error {
  constructor(
...
export class ObservationResource {
  ...
  private config: ObservationResourceConfig;
  ...
  async update(observation: Observation): Promise<Observation> {
  ...
  // ==================== Convenience Methods ====================
  async getVitalSigns(patientId: string, dateRange?: { start: string; end: string }): Promise<any> {
    const params: any = {
      patient: patientId,
  ...
  async getByLoincCode(patientId: string, loincCode: string): Promise<any> {
    return this.search({
      patient: patientId,
...
// ==================== Convenience Factory ====================
export function createObservationResource(client: AtlasFhirClient, config?: Partial<ObservationResourceConfig>): ObservationResource {
